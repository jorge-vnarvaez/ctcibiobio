    ...
    <v-card elevation="4" height="300" rounded="xl">
      <div class="flex space-x-3">
        ...
        <img
          ...
          class="rounded-l-xl object-cover object-left-top h-[300px]"
        />
        <!-- FEATURED IMAGE -->

        <div class="flex flex-col p-4 lg:p-0">
          <div class="h-20 mb-2">
            <!-- TITLE -->
            <span
              class="block mt-2 font-bold text-[15px] lg:text-base whitespace-normal break-normal text-blue-900"
              >{{ material.title }}</span
            >
            <!-- TITLE -->
            ...
            <v-chip
              label
              :color="
                ['Elaboración propia'].includes(material.tag)
                  ? '#2929c6'
                  : '#ff6469'
              "
              text-color="white"
