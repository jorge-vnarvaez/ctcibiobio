<template lang="">
  <div id="organizaciones">
    <section class="px-4 py-24 mx-auto max-w-7xl">
      <h1 class="mb-12 text-sm font-bold tracking-wide text-center text-gray-800 uppercase">ESTAMOS ORGULLOSOS DE PARTICIPAR EN EL DESARROLLO DE LA ESTRATEGIA REGIONAL DE CIENCIA, TECNOLOGÍA, CONOCIMIENTO E INNOVACIÓN</h1>
